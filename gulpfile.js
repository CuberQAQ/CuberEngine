...
const bpfoldername = "CuberEngine";
...
const copy_content = onlyDeployBehaviorPack
  ? gulp.parallel(copy_behavior_packs)
  : gulp.parallel(copy_behavior_packs, copy_resource_packs);

function compile_scripts() {
  console.log("[GULP] compile_scripts...");
  let res = gulp
    .src("scripts/**/*.ts")
  ...
  console.log("[GULP] compile_scripts... DONE!");
  return res;
}
...
function clean_localmc(callbackFunction) {
  console.log("[GULP] clean_localmc...");
  ...
  console.log("[GULP] clean_localmc DONE!");
}
...
const deploy_localmc = gulp.series(
  ...
  onlyDeployBehaviorPack
    ? gulp.parallel(deploy_localmc_behavior_packs)
